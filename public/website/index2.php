...
<body style="width: 100%;" class="" >
    ...
    <div class="container-fluid p-5" style=" background-color: rgba(0, 0, 0, 0.384); color: rgba(255, 255, 255,1)">
        <div class="" style=" margin: 0px;">
            ...
            <stripe-pricing-table pricing-table-id="prctbl_1OPcf2LKQ3OMRNsfLhd0PQMl"
            publishable-key="pk_test_51OPZTYLKQ3OMRNsft6TaRcXPMw4nqWDnwBH9ya67sRRozLxaIx6fOtIoXvbKFABUvGbqu4JVvixFh8MHPuaCgmUQ00reB4rC4k">
